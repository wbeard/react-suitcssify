...
function getClassName(config={}) {
  const defaults = {
    className: this && (this.props.hasOwnProperty('className') && this.props.className) || null,
    ...
    utilities: this && (config.descendantName ? null : (this.props.hasOwnProperty('utilities') && this.props.utilities)) || null
  };
